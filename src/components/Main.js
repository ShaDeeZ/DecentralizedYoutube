    ...
    return (
      <div className="container-fluid text-monospace">
          ...
          <div className="col-md-2 border border-danger overflow-auto text-center" style={{ maxHeight: '768px', minWidth: '175px' }}>
            ...
            <form onSubmit={(event) => {
              event.preventDefault()
              const comment = this.videoComment.value
              ...
              &nbsp;
                <div className="form-group mr-sm-2">
                  <input
                    id="videoComment"
                    type="text"
                    ref={(input) => { this.videoComment = input }}
                    className="form-control-sm"
                    placeholder="Title..."
                    required />
                </div>
            ...
            { this.props.commentsVideo.map((string, key) => {
              return(
                <div className="card mb-4 text-center bg-secondary mx-auto" style={{ width: '175px'}} key={key} >
                  <div className="card-title bg-dark">
                    <small className="text-white"><b>{string}</b></small>
                  </div>
                </div>
              )
            })}
